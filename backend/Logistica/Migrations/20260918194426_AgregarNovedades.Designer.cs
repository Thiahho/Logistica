...
namespace Logistica.Migrations
{
    ...
    [Migration("20260918194426_AgregarNovedades")]
    partial class AgregarNovedades
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Logistica.Entidades.Pedido", b =>
                {
                    ...
                    b.HasOne("Logistica.Entidades.Usuario", "PrecioManualPorUsuario")
                        .WithMany()
                        .HasForeignKey("PrecioManualPor")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("PrecioManualPorUsuario");
