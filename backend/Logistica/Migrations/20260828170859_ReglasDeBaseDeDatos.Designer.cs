...
namespace Logistica.Migrations
{
    ...
    [Migration("20260828170859_ReglasDeBaseDeDatos")]
    partial class ReglasDeBaseDeDatos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Logistica.Entidades.Usuario", b =>
                {
                    ...
                    b.ToTable("usuarios", null, t =>
                        {
                            t.HasCheckConstraint("ck_usuarios_cliente_coherente", "rol <> 'cliente' or cliente_id is not null");

                            t.HasCheckConstraint("ck_usuarios_rol", "rol in ('administracion','operacion','repartidor','cliente')");
                        });
                });
