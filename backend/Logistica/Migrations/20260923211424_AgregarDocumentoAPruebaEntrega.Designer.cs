...
namespace Logistica.Migrations
{
    ...
    [Migration("20260923211424_AgregarDocumentoAPruebaEntrega")]
    partial class AgregarDocumentoAPruebaEntrega
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Logistica.Datos.ParadaRepartidor", b =>
                {
                    ...
                    b.Property<EstadoPedido>("PedidoEstado")
            ...
            modelBuilder.Entity("Logistica.Entidades.Localidad", b =>
                {
                    ...
                    b.Property<string>("DistanciaFuente")
                        .HasColumnType("text")
                        .HasColumnName("distancia_fuente");

                    b.Property<decimal?>("DistanciaKmDeposito")
                        .HasColumnType("numeric(7,1)")
                        .HasColumnName("distancia_km_deposito");
                    ...
                    b.Property<bool>("ZonaManual")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("zona_manual");
            ...
            modelBuilder.Entity("Logistica.Entidades.Novedad", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("PropuestaCampo")
                        .HasColumnType("text")
                        .HasColumnName("propuesta_campo");

                    b.Property<string>("PropuestaValorAnterior")
                        .HasColumnType("text")
                        .HasColumnName("propuesta_valor_anterior");

                    b.Property<string>("PropuestaValorNuevo")
                        .HasColumnType("text")
                        .HasColumnName("propuesta_valor_nuevo");
                    ...
                    b.Property<DateTimeOffset?>("VistoEn")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasIndex("Estado")
                        .HasDatabaseName("ix_novedades_abiertas")
                    ...
                    b.HasIndex("ResueltaPor");

                    b.HasIndex("RutaId", "DeviceUuid")
                        .IsUnique()
                        .HasFilter("device_uuid is not null");

                    b.HasIndex("RutaId", "Estado");

                    b.ToTable("novedades", null, t =>
                        {
            ...
            modelBuilder.Entity("Logistica.Entidades.Pedido", b =>
                {
                    ...
                    b.Property<int?>("BultosDeclaradoCliente")
                        .HasColumnType("integer")
                        .HasColumnName("bultos_declarados_cliente");
                    ...
                    b.Property<decimal?>("KmCobrados")
                        .HasColumnType("numeric(6,2)")
                        .HasColumnName("km_cobrados");

                    b.Property<string>("KmFuente")
                        .HasColumnType("text")
                        .HasColumnName("km_fuente");

                    b.Property<decimal?>("KmManual")
                        .HasColumnType("numeric(6,2)")
                        .HasColumnName("km_manual");

                    b.Property<DateTimeOffset?>("KmManualEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("km_manual_en");

                    b.Property<Guid?>("KmManualPor")
                        .HasColumnType("uuid")
                        .HasColumnName("km_manual_por");
                    ...
                    b.Property<DateTimeOffset?>("PrecioManualEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("precio_manual_en");

                    b.Property<Guid?>("PrecioManualPor")
                        .HasColumnType("uuid")
                        .HasColumnName("precio_manual_por");

                    b.Property<decimal>("RecargoKm")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(12,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("recargo_km");
                    ...
                    b.Property<DateTimeOffset?>("RecepcionConfirmadaEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("recepcion_confirmada_en");

                    b.Property<Guid?>("RecepcionConfirmadaPor")
                        .HasColumnType("uuid")
                        .HasColumnName("recepcion_confirmada_por");
                    ...
                    b.ToTable("pedidos", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_pedidos_origen_coherente", "tipo in ('entrega','delivery') or pedido_origen_id is not null");
            ...
            modelBuilder.Entity("Logistica.Entidades.Ruta", b =>
                {
                    ...
                    b.Property<Guid?>("CerradaPor")
                        .HasColumnType("uuid")
                        .HasColumnName("cerrada_por");

                    b.Property<decimal?>("CierreRepartidorCombustible")
                        .HasColumnType("numeric(12,2)")
                        .HasColumnName("cierre_repartidor_combustible");

                    b.Property<string>("CierreRepartidorDeviceUuid")
                        .HasColumnType("text")
                        .HasColumnName("cierre_repartidor_device_uuid");

                    b.Property<DateTimeOffset?>("CierreRepartidorEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("cierre_repartidor_en");

                    b.Property<int?>("CierreRepartidorKmFinal")
                        .HasColumnType("integer")
                        .HasColumnName("cierre_repartidor_km_final");

                    b.Property<string>("CierreRepartidorNotas")
                        .HasColumnType("text")
                        .HasColumnName("cierre_repartidor_notas");

                    b.Property<decimal?>("CierreRepartidorPeajes")
                        .HasColumnType("numeric(12,2)")
                        .HasColumnName("cierre_repartidor_peajes");
                    ...
                    b.Property<int?>("RetiroBultosContados")
                        .HasColumnType("integer")
                        .HasColumnName("retiro_bultos_contados");

                    b.Property<int?>("RetiroBultosEsperados")
                        .HasColumnType("integer")
                        .HasColumnName("retiro_bultos_esperados");

                    b.Property<DateTimeOffset?>("RetiroConfirmadoEn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("retiro_confirmado_en");

                    b.Property<string>("RetiroDeviceUuid")
                        .HasColumnType("text")
                        .HasColumnName("retiro_device_uuid");

                    b.Property<string>("RetiroFirmaPath")
                        .HasColumnType("text")
                        .HasColumnName("retiro_firma_path");

                    b.Property<int?>("RetiroKmInicial")
                        .HasColumnType("integer")
                        .HasColumnName("retiro_km_inicial");

                    b.Property<string>("RetiroObservaciones")
                        .HasColumnType("text")
                        .HasColumnName("retiro_observaciones");
                    ...
                    b.ToTable("rutas", null, t =>
                        {
                            t.HasCheckConstraint("ck_rutas_cierre_repartidor_montos", "(cierre_repartidor_km_final is null or cierre_repartidor_km_final >= 0) and (cierre_repartidor_combustible is null or cierre_repartidor_combustible >= 0) and (cierre_repartidor_peajes is null or cierre_repartidor_peajes >= 0)");

                            t.HasCheckConstraint("ck_rutas_estado", "estado in ('planificada','en_curso','cerrada')");

                            t.HasCheckConstraint("ck_rutas_retiro_bultos", "(retiro_bultos_esperados is null or retiro_bultos_esperados >= 0) and (retiro_bultos_contados is null or retiro_bultos_contados >= 0)");

                            t.HasCheckConstraint("ck_rutas_retiro_discrepancia_observada", "retiro_confirmado_en is null or retiro_bultos_contados = retiro_bultos_esperados or (retiro_observaciones is not null and btrim(retiro_observaciones) <> '')");

                            t.HasCheckConstraint("ck_rutas_retiro_km_inicial", "retiro_km_inicial is null or retiro_km_inicial >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Logistica.Entidades.Novedad", b =>
                {
                    b.HasOne("Logistica.Entidades.Usuario", "CreadaPorUsuario")
                        .WithMany()
                    ...
                    b.HasOne("Logistica.Entidades.Usuario", "ResueltaPorUsuario")
                        .WithMany()
                        .HasForeignKey("ResueltaPor")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Logistica.Entidades.Pedido", b =>
                {
                    ...
                    b.HasOne("Logistica.Entidades.Usuario", "KmManualPorUsuario")
                        .WithMany()
                        .HasForeignKey("KmManualPor")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Logistica.Entidades.Usuario", "RecepcionConfirmadaPorUsuario")
                        .WithMany()
                    ...
                    b.Navigation("KmManualPorUsuario");
