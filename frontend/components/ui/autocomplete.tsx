...
// No existe como componente del CLI de shadcn en el registry base-nova (solo "combobox" — ver
// intento `npx shadcn add autocomplete`, 404). Se escribe a mano espejando components/ui/combobox.tsx
// parte por parte: mismos data-slot, mismas clases, mismo patrón de tipos derivados de
// AutocompletePrimitive.Parte.Props. La diferencia real con Combobox: acá el valor es el TEXTO
// tipeado (Autocomplete.Root.value/onValueChange), no un item de la lista — la lista solo sugiere.
...
function AutocompleteItem({
  ...
  return (
    <AutocompletePrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-md py-1.5 pl-1.5 pr-2 text-sm outline-hidden select-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50",
        className
      )}
      {...props}
    />
