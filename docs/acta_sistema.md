...
**Versión 4.21 — Documento consolidado · 24/09/2026**
...
- **RF-42** Rango de cliente (Sin rango, Bronce, Plata, Oro, Empresa) recalculado cada trimestre con umbrales configurables, con un ajuste manual de un rango como máximo, justificado y con vencimiento, e historial de cada cambio. El rango da un descuento sobre la tarifa general. *(Changelog 4.21, gobernanza — sin código todavía.)*
