...
**Techo vigente: 18 tablas (changelog 1.22, acta 4.8).** El de 13 de arriba quedó superado por 3.3 (`clientes_usuarios`, 14), E1 (`facturas`/`factura_items`/`pagos`, 17) y ahora `novedades` (18). Cada cruce lleva su justificación en el acta; el de 4.8 es que el reporte de la calle son varias filas por ruta con historial y respuesta, y una columna aditiva admite un solo reporte y ninguna respuesta.
...
total             = precio_base + recargo_km + recargo_urgencia − descuento_ruta + peajes
```
