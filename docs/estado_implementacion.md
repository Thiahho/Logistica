...
### 3.23 Preparación del despliegue (`backend/Logistica/Dockerfile`, `frontend/next.config.ts`, `lib/auth/AuthProvider.tsx`) — changelog acta 4.19
...
- `docs/acta_sistema.md` v4.19 (reglas de negocio vigentes)
